...
HD_PWD='C:/Users/SFG/Desktop/Digital_Design_Project/Top_Level_Datapath/Top_Level_Datapath.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Top_Level_Datapath.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Top_Level_Datapath.tcl -notrace
