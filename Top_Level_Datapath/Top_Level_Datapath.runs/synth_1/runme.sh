...
HD_PWD='C:/Users/SFG/Desktop/Digital_Design_Project/Top_Level_Datapath/Top_Level_Datapath.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Top_Level_Datapath.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Top_Level_Datapath.tcl
